...
<!-- your webpage info goes here -->
	...
	<meta name="author" content="Swoyam" />
...
<!-- webpage content goes here in the body -->
	...
	<div id="page">
		<div id="logo">
			<h1><a href="/" id="lit.jpg">My First Website</a></h1>
		</div>
		<div id="nav">
			<ul>
				<li><a href="#/lit.jpg">Home</a></li>
		...
		<div id="footer">
			<p>
				Webpage made by <a href="/" target="_blank">[SWOYAM PRAKASH PANDA]</a>
			</p>
		</div>
	</div>
</body>
